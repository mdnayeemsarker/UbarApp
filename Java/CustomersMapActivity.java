        ...
        com.google.android.gms.location.LocationListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Logout = (Button) findViewById(R.id.customerLogOutBtnId);
        SettingsButton = (Button) findViewById(R.id.customerSettingsBtnId);
        CallCabCarButton = (Button) findViewById(R.id.customerCallId);
        ...
        linearLayout = findViewById(R.id.rel1);
                ...
                .addValueEventListener(new ValueEventListener()
                {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        if (dataSnapshot.exists() && requestType)
                        {
                            ...
                            Toast.makeText(CustomersMapActivity.this, "Again Press the button to cancel the Ride", Toast.LENGTH_LONG).show();

                            check.equals("ok");

                            CancelCustomerRequests();
    ...
    public void CancelCustomerRequests()
    {
        if (check.equals("ok"))
        {
