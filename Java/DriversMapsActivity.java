...
public class DriversMapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogoutDriverBtn = (Button) findViewById(R.id.driverLogOutBtnId);
        SettingsDriverButton = (Button) findViewById(R.id.driverSettingsBtnId);
        ...
        linearLayout = findViewById(R.id.rel2);
    ...
    {
        Intent startPageIntent = new Intent(DriversMapsActivity.this, WelcomeActivity.class);
